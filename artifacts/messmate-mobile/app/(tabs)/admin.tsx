...
export default function AdminScreen() {
  ...
  const { profile, inventory, attendance, leaves, payments, expenses, feedback, updateLeaveStatus } = useMess();
